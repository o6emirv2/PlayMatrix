...
function writeStartupEnvReport() {
  const safeReport = {
    ...
    public: runtimeEnvReport.public,
    credentialSignals: runtimeEnvReport.credentialSignals,
    allowedCorsOrigins: getAllowedCorsOrigins()
  };
  try {
    console.info('[PlayMatrix][runtime] sanitized env report:', JSON.stringify(safeReport));
  } catch (error) {
    console.warn('[PlayMatrix][runtime] sanitized env report yazılamadı:', error?.message || String(error));
  }
}
...
const CANONICAL_GAME_PAGES = Object.freeze([
  {
    label: 'Crash.html',
    filePath: firstExistingPath([path.join(__dirname, 'Online Oyunlar', 'Crash.html'), path.join(__dirname, 'Crash.html')]),
    canonicalRoutes: ['/Online Oyunlar/Crash', '/Online%20Oyunlar/Crash'],
    legacyRoutes: ['/Online Oyunlar/Crash.html', '/Online%20Oyunlar/Crash.html', '/Crash.html', '/crash', '/online-games/crash']
  },
  {
    label: 'Pisti.html',
    filePath: firstExistingPath([path.join(__dirname, 'Online Oyunlar', 'Pisti.html'), path.join(__dirname, 'OnlinePisti.html'), path.join(__dirname, 'Pisti.html')]),
    canonicalRoutes: ['/Online Oyunlar/Pisti', '/Online%20Oyunlar/Pisti'],
    legacyRoutes: ['/Online Oyunlar/Pisti.html', '/Online%20Oyunlar/Pisti.html', '/Pisti.html', '/OnlinePisti.html', '/pisti', '/online-games/pisti']
  },
  {
    label: 'Satranc.html',
    filePath: firstExistingPath([path.join(__dirname, 'Online Oyunlar', 'Satranc.html'), path.join(__dirname, 'Satranc.html')]),
    canonicalRoutes: ['/Online Oyunlar/Satranc', '/Online%20Oyunlar/Satranc'],
    legacyRoutes: ['/Online Oyunlar/Satranc.html', '/Online%20Oyunlar/Satranc.html', '/Satranc.html', '/satranc', '/online-games/chess']
  },
  {
    label: 'SnakePro.html',
    filePath: firstExistingPath([path.join(__dirname, 'Klasik Oyunlar', 'SnakePro.html')]),
    canonicalRoutes: ['/Klasik Oyunlar/SnakePro', '/Klasik%20Oyunlar/SnakePro'],
    legacyRoutes: ['/Klasik Oyunlar/SnakePro.html', '/Klasik%20Oyunlar/SnakePro.html']
  },
  {
    label: 'PatternMaster.html',
    filePath: firstExistingPath([path.join(__dirname, 'Klasik Oyunlar', 'PatternMaster.html')]),
    canonicalRoutes: ['/Klasik Oyunlar/PatternMaster', '/Klasik%20Oyunlar/PatternMaster'],
    legacyRoutes: ['/Klasik Oyunlar/PatternMaster.html', '/Klasik%20Oyunlar/PatternMaster.html']
  },
  {
    label: 'SpacePro.html',
    filePath: firstExistingPath([path.join(__dirname, 'Klasik Oyunlar', 'SpacePro.html')]),
    canonicalRoutes: ['/Klasik Oyunlar/SpacePro', '/Klasik%20Oyunlar/SpacePro'],
    legacyRoutes: ['/Klasik Oyunlar/SpacePro.html', '/Klasik%20Oyunlar/SpacePro.html']
  }
]);

function mountCanonicalGamePage({ label, filePath, canonicalRoutes = [], legacyRoutes = [] }) {
  if (!filePath) {
  ...
  uniqueCanonicalRoutes.forEach((routePath) => {
    app.get(routePath, enforceMaintenanceMode, (_req, res) => {
      setHtmlHeaders(res);
      return res.sendFile(filePath);
    });
  });
  ...
  writeLine('info', 'canonical_game_page_mounted', { label, canonicalRoutes: uniqueCanonicalRoutes, legacyRoutes: uniqueLegacyRoutes });
}
...
app.get(['/Online Oyunlar/Satranc', '/Online Oyunlar/Satranc.html', '/Satranc.html', '/online-games/chess', '/satranc'], enforceMaintenanceMode);
app.get(['/Online Oyunlar/Pisti', '/Online Oyunlar/Pisti.html', '/Pisti.html', '/OnlinePisti.html', '/online-games/pisti', '/pisti'], enforceMaintenanceMode);
app.get(['/Online Oyunlar/Crash', '/Online Oyunlar/Crash.html', '/Crash.html', '/crash', '/online-games/crash'], enforceMaintenanceMode);
app.get(['/Klasik Oyunlar/PatternMaster', '/Klasik Oyunlar/PatternMaster.html', '/Klasik Oyunlar/SnakePro', '/Klasik Oyunlar/SnakePro.html', '/Klasik Oyunlar/SpacePro', '/Klasik Oyunlar/SpacePro.html'], enforceMaintenanceMode);
...
mountGameHtmlAliases(
  ...
  ['/Online Oyunlar/Satranc', '/Online Oyunlar/Satranc.html', '/Satranc.html', '/online-games/chess', '/satranc']
);
...
mountGameHtmlAliases(
  ...
  ['/Online Oyunlar/Pisti', '/Online Oyunlar/Pisti.html', '/Pisti.html', '/OnlinePisti.html', '/online-games/pisti', '/pisti']
);
...
mountGameHtmlAliases(
  ...
  ['/Online Oyunlar/Crash', '/Online Oyunlar/Crash.html', '/Crash.html', '/crash', '/online-games/crash']
);

...
function writeStartupEnvReport() {
  ...
  try {
    console.info('[PlayMatrix][runtime] startup env summary:', JSON.stringify(safeReport));
  } catch (error) {
    console.warn('[PlayMatrix][runtime] startup env summary yazılamadı:', error?.message || String(error));
  }
}

...
router.post('/notifications/system', requireAuth, requireAdmin, requireAdminReauth, (req, res) => {
  ...
  Promise.resolve(writeAdminAudit(req, 'admin.notifications.system.send', { notificationId: row.id, title: explicitTitle, scope: 'system' })).catch(() => null);

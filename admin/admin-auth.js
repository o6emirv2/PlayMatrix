const PM_ADMIN_AUTH = (() => {
  ...
  function normalizeAdminFirebaseAuthError(error) {
    ...
    const map = {
      'auth/configuration-not-found': 'Giriş yapılandırması şu anda hazır değil. Lütfen ayarları kontrol edip tekrar dene.',
      'auth/network-request-failed': 'Giriş bağlantısı kurulamadı. Lütfen internet bağlantını kontrol edip tekrar dene.',
      'PUBLIC_FIREBASE_CONTRACT_MISMATCH': 'Giriş ayarları doğrulanamadı. Lütfen sistem ayarlarını kontrol et.'
    };

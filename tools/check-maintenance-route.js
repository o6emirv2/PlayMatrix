...
if (fs.existsSync(path.join(root, 'Bakim'))) fail('Bakim/ ASCII fallback klasörü kullanılmamalı; tek standart Bakım/ olmalı.');
if (fs.existsSync(path.join(root, 'Bak─▒m'))) fail('Bak─▒m/ bozuk encoding klasörü temizlenmeli; tek standart Bakım/ olmalı.');
if (fs.existsSync(path.join(root, 'BakÄ±m'))) fail('BakÄ±m/ bozuk encoding klasörü temizlenmeli; tek standart Bakım/ olmalı.');

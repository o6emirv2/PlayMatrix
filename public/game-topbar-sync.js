(function(){
  ...
  function ensurePulseStyles(){ if(document.getElementById('pm-live-sync-pulse-style')) return; const style=document.createElement('style'); style.id='pm-live-sync-pulse-style'; style.textContent='@keyframes pmLiveSyncPulse{0%{filter:brightness(1);transform:translateZ(0) scale(1)}45%{filter:brightness(1.35);transform:translateZ(0) scale(1.045)}100%{filter:brightness(1);transform:translateZ(0) scale(1)}}.pm-live-sync-pulse{animation:pmLiveSyncPulse .65s ease both}.pm-topbar-avatar-only{width:100%;height:100%;object-fit:cover;border-radius:50%;display:block}.top-bar-full,.account-level-section{overflow:visible!important}.account-level-section{padding-left:6px!important}.pm-game-topbar-avatar-host{width:52px!important;height:52px!important;min-width:52px!important;flex:0 0 52px!important;margin-left:3px!important;border-radius:18px!important;overflow:visible!important;display:grid!important;place-items:center!important;isolation:isolate!important;background:linear-gradient(145deg,rgba(255,255,255,.09),rgba(255,255,255,.03))!important;border:1px solid rgba(255,255,255,.12)!important}.pm-game-topbar-avatar-host .pm-avatar,.pm-game-topbar-avatar-host [data-pm-avatar=true]{width:50px!important;height:50px!important;max-width:50px!important;max-height:50px!important;overflow:visible!important;display:grid!important;place-items:center!important}.pm-game-topbar-avatar-host .pm-avatar-img,.pm-game-topbar-avatar-host img:not(.pm-frame-image):not(.pm-avatar-shell__frame):not(.pm-game-frame){display:block!important;width:100%!important;height:100%!important;object-fit:cover!important;border-radius:50%!important;transform:translate3d(calc(-50% + var(--pm-avatar-shift-x,0px)),calc(-50% + var(--pm-avatar-shift-y,0px)),0) scale(var(--pm-avatar-scale,1))!important}.pm-game-topbar-avatar-host .pm-frame-image,.pm-game-topbar-avatar-host .pm-avatar-shell__frame,.pm-game-topbar-avatar-host .pm-game-frame{display:block!important;visibility:visible!important;position:absolute!important;left:50%!important;top:50%!important;width:calc(100% * var(--pm-frame-scale,1.18))!important;height:calc(100% * var(--pm-frame-scale,1.18))!important;max-width:none!important;max-height:none!important;object-fit:contain!important;transform:translate3d(calc(-50% + var(--pm-frame-shift-x,0px)),calc(-50% + var(--pm-frame-shift-y,0px)),0)!important;z-index:4!important;pointer-events:none!important}@media(max-width:480px){.account-level-section{padding-left:7px!important;gap:10px!important}.pm-game-topbar-avatar-host{width:44px!important;height:44px!important;min-width:44px!important;flex-basis:44px!important;margin-left:2px!important}.pm-game-topbar-avatar-host .pm-avatar,.pm-game-topbar-avatar-host [data-pm-avatar=true]{width:42px!important;height:42px!important}}'; document.head.appendChild(style); }

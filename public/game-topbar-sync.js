(function(){
  ...
  function ensurePulseStyles(){ if(document.getElementById('pm-live-sync-pulse-style')) return; const style=document.createElement('style'); style.id='pm-live-sync-pulse-style'; style.textContent='@keyframes pmLiveSyncPulse{0%{filter:brightness(1);transform:translateZ(0) scale(1)}45%{filter:brightness(1.35);transform:translateZ(0) scale(1.045)}100%{filter:brightness(1);transform:translateZ(0) scale(1)}}.pm-live-sync-pulse{animation:pmLiveSyncPulse .65s ease both}.pm-topbar-avatar-only{width:100%;height:100%;object-fit:cover;border-radius:50%;display:block}.pm-game-topbar-avatar-host{width:52px!important;height:52px!important;min-width:52px!important;flex:0 0 52px!important;border-radius:18px!important;overflow:visible!important;display:grid!important;place-items:center!important;isolation:isolate!important;background:linear-gradient(145deg,rgba(255,255,255,.09),rgba(255,255,255,.03))!important;border:1px solid rgba(255,255,255,.12)!important}.pm-game-topbar-avatar-host .pm-avatar,.pm-game-topbar-avatar-host [data-pm-avatar=true]{width:50px!important;height:50px!important;max-width:50px!important;max-height:50px!important;overflow:visible!important;display:grid!important;place-items:center!important}.pm-game-topbar-avatar-host .pm-avatar-img,.pm-game-topbar-avatar-host img:not(.pm-frame-image):not(.pm-avatar-shell__frame):not(.pm-game-frame){display:block!important;width:100%!important;height:100%!important;object-fit:cover!important;border-radius:50%!important}.pm-game-topbar-avatar-host .pm-frame-image,.pm-game-topbar-avatar-host .pm-avatar-shell__frame,.pm-game-topbar-avatar-host .pm-game-frame{display:block!important;visibility:visible!important;position:absolute!important;left:50%!important;top:50%!important;width:124%!important;height:124%!important;max-width:none!important;max-height:none!important;object-fit:contain!important;transform:translate(-50%,-50%)!important;z-index:4!important;pointer-events:none!important}@media(max-width:480px){.pm-game-topbar-avatar-host{width:44px!important;height:44px!important;min-width:44px!important;flex-basis:44px!important}.pm-game-topbar-avatar-host .pm-avatar,.pm-game-topbar-avatar-host [data-pm-avatar=true]{width:42px!important;height:42px!important}}'; document.head.appendChild(style); }
  function mountAvatar(profile){
    ...
    for(const host of hosts){
      ...
      if(window.PMAvatar?.mount){
        try{
          window.PMAvatar.mount(host,{ avatarUrl:avatar, level:allowedFrame ? renderLevel : 0, exactFrameIndex:allowedFrame ? exactFrameIndex : 0, frameUrl:allowedFrame ? frameUrl : '', sizePx:50, wrapperClass:'pm-avatar pm-game-topbar-avatar', imageClass:'pm-avatar-img', variant, sizeTag:variant, alt:'Hesap avatarı' });

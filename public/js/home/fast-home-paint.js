(function () {
  ...
  const GAMES = [
    { name: 'Crash', category: 'online', access: 'auth', url: '/Online Oyunlar/Crash', color: '69,162,255', icon: 'fa-arrow-trend-up', desc: 'Gerçek para içermeyen, refleks ve zamanlama odaklı hızlı tempo multiplier oyunu.', tags: ['Canlı Oyun', 'Rekabet', 'Hızlı Tur'] },
    { name: 'Satranç', category: 'online', access: 'auth', url: '/Online Oyunlar/Satranc', color: '104,178,255', icon: 'fa-chess', desc: 'Klasik satranç deneyimini modern arayüz ve giriş tabanlı rekabet akışıyla oyna.', tags: ['PvP', 'Strateji', 'Arena'] },
    { name: 'Pişti', category: 'online', access: 'auth', url: '/Online Oyunlar/Pisti', color: '93,95,254', icon: 'fa-layer-group', desc: 'Kart takibi ve tempo yönetimi isteyen online pişti deneyimi.', tags: ['Kart', 'Online', 'Klasik'] },
    { name: 'Pattern Master', category: 'classic', access: 'free', url: '/Klasik Oyunlar/PatternMaster', color: '97,220,176', icon: 'fa-shapes', desc: 'Dikkat ve görsel hafıza odaklı ücretsiz pattern oyunu.', tags: ['Ücretsiz', 'Zeka', 'Refleks'] },
    { name: 'Space Pro', category: 'classic', access: 'free', url: '/Klasik Oyunlar/SpacePro', color: '103,170,255', icon: 'fa-user-astronaut', desc: 'Tarayıcıda anında açılan hafif ve hızlı klasik arcade uzay oyunu.', tags: ['Arcade', 'Retro', 'Ücretsiz'] },
  ...
  function renderGameCard(game) {
    ...
    button.append(text('span', '', game.access === 'auth' ? 'Giriş Yap ve Oyna' : 'Hemen Oyna'), icon('fa-arrow-right'));
